...
class NotImplementedMethodError(NotImplementedError):
    ...
    Examples
    --------
    >>> from bifree._private_tools.exceptions import NotImplementedMethodError
    ...
    def __init__(self):
        ...
        from bifree import __github_issues_web__
...
class NotImplementedClassError(NotImplementedError):
    ...
    Examples
    --------
    >>> from bifree._private_tools.exceptions import NotImplementedClassError
    >>> class ClassName():
    ...    def __init__(self):
...
class BadCallError(ValueError):
    ...
    Examples
    --------
    >>> from bifree._private_tools.exceptions import BadCallError
